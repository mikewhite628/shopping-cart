...
const Inventory = [
    {
      name: 'Fender Custom Shop Sigil Collection Game of Thrones House Targaryen Stratocaster Dragonglass Black',
      price: '$35,000.00',
    ...
    {
      name: 'Fender Custom Shop Limited-Edition George Harrison Rocky Stratocaster Electric Guitar Custom Artwork',
      price: '$25,000.00',
    ...
    {
      name: 'PRS Private Stock McCarty 594 with Curly Maple Top Electric Guitar Aqua Violet',
      price: '$11,825.00',
    ...
    {
      name: 'Gibson Custom Tom Murphy 1959 Les Paul Standard Electric Guitar  Aged Cherry Burst',
      price: '$11,499.00',
    ...
    {
      name: 'Fender American Performer Stratocaster Rosewood Fingerboard Electric Guitar  Aged White',
      price: '$1,199.99',
    ...
    {
      name: 'Fender Artist Series Eric Clapton Stratocaster Electric Guitar  Pewter',
      price: '$1,849.99',
    ...
    {
      name: 'Fender American Professional Telecaster Maple Fingerboard Electric Guitar  Butterscotch Blonde',
      price: '$1,549.99',
    ...
    {
      name: 'Fender American Ultra Stratocaster HSS Maple Fingerboard Electric Guitar  Arctic Pearl',
      price: '$1,949.99',
